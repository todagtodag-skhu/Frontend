import { ChildProfile, Mission, StickerBoard } from '@/components/todagi/types';
...
export const growthMockChildren: ChildProfile[] = [
  {
    id: 'child-1',
    inviteCode: '123456',
    name: '유지니유진',
...
export const growthMockStickerBoards: StickerBoard[] = [
  {
    id: 'board-1',
    childId: 'child-1',
    title: '유지니유진의 성장나무',
...
export const completedStickerBoardMocks: CompletedStickerBoard[] = [
  {
    id: 'board-1',
    title: '유진이의 성장나무',
    reward: '닌텐도 스위치',
...
export const defaultTreeMissionMocks: TreeMission[] = [
